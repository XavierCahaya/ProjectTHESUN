...
return [
    ...
    'soloinfo' => '<ul class="ml-5 mb-6 text-body">
    ...
    class="ml-5 mb-2 text-2xl font-bold tracking-tight text-heading">Hainan Package 5 Days 3 Nights
    </h5>
    <ul class="ml-5 mb-6 text-body">
        <li style="font-family: \'Roboto\', sans-serif;">1. 3 Tourist Destinations</li>
        <li style="font-family: \'Roboto\', sans-serif;">2. Flight Tickets (Full)</li>
...
<ul class="ml-5 mb-6 text-body">
    <li style="font-family: \'Roboto\', sans-serif;">1. 3 Tourist Destinations</li>
    <li style="font-family: \'Roboto\', sans-serif;">2. Flight Tickets (Full)</li>
    <li style="font-family: \'Roboto\', sans-serif;">3. 4-Star Hotel</li>
    <li style="font-family: \'Roboto\', sans-serif;">4. Meals (Full)</li>
</ul>',
